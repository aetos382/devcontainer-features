...
- Only Ubuntu 22.04 and later are supported. On older releases such as 20.04, apt does not recognize `APT::Update::Error-Mode`, so an unreachable `mirror` may not fail the build.
