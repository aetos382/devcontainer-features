...
Installs the 1Password CLI (op) from 1Password's signed release archive, verifying the GPG signature and leaving no apt repository in the image.
...
|-----|-----|-----|-----|
| version | Version of the 1Password CLI to install. Either 'latest' or an exact version such as '2.39.0'. | string | latest |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/aetos382/devcontainer-features/blob/main/src/op/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
